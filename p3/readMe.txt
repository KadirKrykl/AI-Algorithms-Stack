...
c.txt is capasicty of knapsack problem.(Maximum limit of weight total of genes.)
w.txt is weight of geness.
v.txt is values of genes.
out.txt isthe output of the individual with the most ideal gene adhering to the limit.
